...
file tb_control là file Testbench ( hiện tại thì đang bị lỗi không mở đọc file được , những mẫu nhỏ kiểu tự tạo thì tính toán vẫn đúng ).
